    ...
    <div class="mb-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-slate-500">Modifique los datos del grupo familiar.</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="apellidos" id="apellidos" required 
                                ...
                                placeholder="Ej. Familia Pérez Rodríguez" value="{{ old('apellidos', $familia->apellidos) }}">
                            @error('apellidos')
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="manzana_id" id="manzana_id" required 
                                ...
                                @foreach($manzanas as $manzana)
                                    <option value="{{ $manzana->id }}" {{ old('manzana_id', $familia->manzana_id) == $manzana->id ? 'selected' : '' }}>
                                        {{ $manzana->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="numero_casa" id="numero_casa" 
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 transition-all text-sm"
                                style="--tw-ring-color: color-mix(in srgb, var(--theme-color) 20%, transparent); border-color: transparent;"
                                placeholder="Ej. A-12" value="{{ old('numero_casa', $familia->numero_casa) }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="calle_transversal" id="calle_transversal" 
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 transition-all text-sm"
                                style="--tw-ring-color: color-mix(in srgb, var(--theme-color) 20%, transparent); border-color: transparent;"
                                placeholder="Ej. Cruce con Av. Bolivar" value="{{ old('calle_transversal', $familia->calle_transversal) }}">
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="numero_habitantes" id="numero_habitantes" min="0"
                                    ...
                                    onfocus="this.style.borderColor = 'var(--theme-color)'"
                                    onblur="this.style.borderColor = 'transparent'"
                                    placeholder="Ej. 4" value="{{ old('numero_habitantes', $familia->numero_habitantes) }}">
