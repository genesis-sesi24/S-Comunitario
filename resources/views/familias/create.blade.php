...
@section('content')
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-slate-600">Complete la información para registrar un nuevo grupo familiar.</p>
    </div>

    <div class="max-w-3xl">
        <form action="{{ route('familias.store') }}" method="POST" class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 sm:p-8">
            @csrf
