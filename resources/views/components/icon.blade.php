...
<svg {{ $attributes->merge(['class' => $class]) }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    @switch($name)
        ...
        @case('ambulance')
            ...
            <!-- (Actually that's lightning bolt, let's use a better ambulance or generic cross) -->
            <!-- Better Cross -->
        ...
        @case('eye')
            ...
            @break
        @case('tooth')
             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 2a2 2 0 00-2 2v2a2 2 0 01-2 2 2 2 0 000 4 2 2 0 012 2v2a2 2 0 002 2h10a2 2 0 002-2v-2a2 2 0 012-2 2 2 0 000-4 2 2 0 01-2-2V4a2 2 0 00-2-2H7z"/>
            @break
        @default
